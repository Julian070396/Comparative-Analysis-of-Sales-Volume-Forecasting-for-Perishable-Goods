...
general <- read.csv("inputs/Purchase_Channel_Level.csv", stringsAsFactors = FALSE)
...
final_df_PL <- final_df %>%
  mutate(Level = "Purchase_Level")  # Add a new column Status with value "Linear-Training"
